...
const contractName = "";  // <= Name of the smart contract

const testLabel = "generic"; // <= Name of the test
const testDirSuffix = "generic"; // <= directory to compare device snapshots to
